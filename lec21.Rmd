...
\onslide<3->{&= \onslide<5->{\left(\frac{0.5}{0.5-t}\right)^{0.5}}\int\limits_{-\infty}^{\infty}\frac{1}{\onslide<4->{\left(\frac{0.5}{0.5-t}\right)^{0.5}}\sqrt{2\pi}}e^{ 
  -\frac{1}{2}\left(\frac{z-0}{\left(\frac{0.5}{0.5-t}\right)^{0.5}}\right)^2}}
\end{align*}
...
\pause \textbf{Theorem:} If $Z_1,\ldots,Z_n$ are i.i.d. $N(0,1)$, then $\sum\limits_{i=1}^n Z^2 \sim \chi^2_n$.
...
\pause \textbf{Theorem:} If $X$ and $Y$ are independent with $X \sim \chi^2_m$ and $X + Y \sim \chi^2_{n+m}$, then $Y \sim \chi^2_m$.
